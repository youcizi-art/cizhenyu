...
import { H as Hono } from "./hono_ByvlA4ML.mjs";
import { c as cors } from "./index_oKH0goKJ.mjs";
import { s as sql, b as sqliteTable, d as integer, t as text, f as createDbClient, e as eq, g as and } from "./index_BD72pzcV.mjs";
import { g as getAuthInstances, p as passwordHasher } from "./node_CRCzDpXu.mjs";
import { g as getValidatedMapping } from "./domains_DPd9JV7W.mjs";
...
sfApp.get("/p/callback/:provider", async (c) => {
  ...
  try {
    ...
    if (email) {
      ...
      const tenantId = Number(domains?.tenant_id || domains?.id || (domains?.site_domains ? domains.site_domains.id : 1) || 1);
