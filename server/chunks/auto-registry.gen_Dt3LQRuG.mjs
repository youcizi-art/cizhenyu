...
const aiSkillMarketAdminUI = typeof window !== "undefined" ? reactExports.lazy(() => import("./index_BI75y5u7.mjs").catch(() => ({ default: () => null }))) : (() => null);
const lowcodeDeployerAdminUI = typeof window !== "undefined" ? reactExports.lazy(() => import("./index_SKsljlGn.mjs").catch(() => ({ default: () => null }))) : (() => null);
const oauthLoginAdminUI = typeof window !== "undefined" ? reactExports.lazy(() => import("./index_BSKoMLIf.mjs").catch(() => ({ default: () => null }))) : (() => null);
const PLUGIN_CODE_REGISTRY = {
  ...
  "oauth-login": {
    ...
    getAdminApp: async () => {
      try {
        const mod = await import("./index_C67v0Niw.mjs");
        return mod.default?.admin || mod.admin || mod.adminApp;
      } catch (e) {
    ...
    getInit: async () => (await import("./index_C67v0Niw.mjs").catch(() => ({}))).default?.init,
