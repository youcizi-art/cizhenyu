...
const aiSkillMarketAdminUI = typeof window !== "undefined" ? reactExports.lazy(() => import("./index_Bf5m1VYD.mjs").catch(() => ({ default: () => null }))) : (() => null);
const lowcodeDeployerAdminUI = typeof window !== "undefined" ? reactExports.lazy(() => import("./index_Cn4tLSYA.mjs").catch(() => ({ default: () => null }))) : (() => null);
const oauthLoginAdminUI = typeof window !== "undefined" ? reactExports.lazy(() => import("./index_Dc3rhWl8.mjs").catch(() => ({ default: () => null }))) : (() => null);
