...
const aiSkillMarketAdminUI = typeof window !== "undefined" ? reactExports.lazy(() => import("./index_DORd3icX.mjs").catch(() => ({ default: () => null }))) : (() => null);
const oauthLoginAdminUI = typeof window !== "undefined" ? reactExports.lazy(() => import("./index_DA4Hya3Z.mjs").catch(() => ({ default: () => null }))) : (() => null);
const PLUGIN_CODE_REGISTRY = {
  "ai-skill-market": {
    manifest: MANIFEST$1,
    getAdminApp: async () => {
      try {
        const mod = await import("./AgentCapabilityService_7Qu4NtWW.mjs").then((n) => n.i);
    ...
    getInit: async () => (await import("./AgentCapabilityService_7Qu4NtWW.mjs").then((n) => n.i).catch(() => ({}))).default?.init,
  ...
  "oauth-login": {
    ...
    getAdminApp: async () => {
      try {
        const mod = await import("./index_CRTdKl6H.mjs");
        return mod.default?.admin || mod.admin || mod.adminApp;
      } catch (e) {
    ...
    getInit: async () => (await import("./index_CRTdKl6H.mjs").catch(() => ({}))).default?.init,
