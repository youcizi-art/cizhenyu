...
export declare function getGlobalServices({ sharedOptions, allWorkerRoutes, fallbackWorkerName, loopbackPort, log, proxyBindings, durableObjectClassNames, workflowOptions, allWorkerOpts, }: GlobalServicesOptions): Service[];
